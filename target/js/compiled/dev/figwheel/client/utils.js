...
var or__3920__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj24729 = {"detail":data};
return obj24729;
})()));
} else {
...
var and__3909__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__24736 = cljs.core._EQ_;
var expr__24737 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__24736.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__24737))){
return ((function (pred__24736,expr__24737){
return (function (p1__24730_SHARP_){
return console.warn(p1__24730_SHARP_);
});
;})(pred__24736,expr__24737))
} else {
if(cljs.core.truth_(pred__24736.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__24737))){
return ((function (pred__24736,expr__24737){
return (function (p1__24731_SHARP_){
return console.debug(p1__24731_SHARP_);
});
;})(pred__24736,expr__24737))
} else {
if(cljs.core.truth_(pred__24736.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__24737))){
return ((function (pred__24736,expr__24737){
return (function (p1__24732_SHARP_){
return console.error(p1__24732_SHARP_);
});
;})(pred__24736,expr__24737))
} else {
return ((function (pred__24736,expr__24737){
return (function (p1__24733_SHARP_){
return console.log(p1__24733_SHARP_);
});
;})(pred__24736,expr__24737))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__24740){
var map__24741 = p__24740;
var map__24741__$1 = ((((!((map__24741 == null)))?(((((map__24741.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24741.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24741):map__24741);
var opts = map__24741__$1;
var eval_fn = cljs.core.get.call(null,map__24741__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__24743_SHARP_);
});})(new_def))
);
...
return (function (p__24744){
var vec__24745 = p__24744;
var ky = cljs.core.nth.call(null,vec__24745,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1662169255893

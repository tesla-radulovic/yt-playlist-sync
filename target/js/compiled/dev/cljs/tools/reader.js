...
var G__24283 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24283;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24284 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24284,ch);
...
if(("\\" === ch__$1)){
var ch_24285__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24285__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24285__$2);
} else {
}

var G__24286 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24286;
continue;
}
}
...
var vec__24294 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24294,(0),null);
var start_column = cljs.core.nth.call(null,vec__24294,(1),null);
...
var G__24297 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24297;
continue;
}
}
...
var _STAR_read_delim_STAR_24298 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_24298;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24299 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24299,(0),null);
var start_column = cljs.core.nth.call(null,vec__24299,(1),null);
...
var vec__24302 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24302,(0),null);
var end_column = cljs.core.nth.call(null,vec__24302,(1),null);
...
var vec__24305 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24305,(0),null);
var start_column = cljs.core.nth.call(null,vec__24305,(1),null);
...
var vec__24308 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24308,(0),null);
var end_column = cljs.core.nth.call(null,vec__24308,(1),null);
...
var vec__24311 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24311,(0),null);
var start_column = cljs.core.nth.call(null,vec__24311,(1),null);
...
var vec__24314 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24314,(0),null);
var end_column = cljs.core.nth.call(null,vec__24314,(1),null);
...
var sb = (function (){var G__24317 = (new goog.string.StringBuffer());
G__24317.append(initch);
...
var G__24319 = (function (){var G__24318 = sb;
G__24318.append(ch);

return G__24318;
})();
var G__24320 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24319;
ch = G__24320;
continue;
}
...
switch (G__24323) {
case "\\":
var G__24327 = (function (){var G__24324 = sb;
G__24324.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24324;
})();
var G__24328 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24327;
ch = G__24328;
continue;
...
break;
default:
var G__24329 = (function (){var G__24325 = sb;
G__24325.append(ch);
...
var vec__24331 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24331,(0),null);
var end_column = cljs.core.nth.call(null,vec__24331,(1),null);
...
var line = cljs.core.nth.call(null,vec__24334,(0),null);
var column = cljs.core.nth.call(null,vec__24334,(1),null);
...
var vec__24339 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24339,(0),null);
var column = cljs.core.nth.call(null,vec__24339,(1),null);
...
var vec__24344 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24344,(0),null);
var column = cljs.core.nth.call(null,vec__24344,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24349 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24349,(0),null);
var start_column = cljs.core.nth.call(null,vec__24349,(1),null);
...
var vec__24352 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24352,(0),null);
var end_column = cljs.core.nth.call(null,vec__24352,(1),null);
...
var G__24355 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24355,true,null,opts,pending_forms);
...
var G__24356 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24356)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24356)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24356)){
...
var _STAR_suppress_read_STAR_24357 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24357;
}});
...
var G__24358 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24358,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24358,rdr,first_line);
...
var G__24362 = matched;
var G__24363 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24362;
finished = G__24363;
continue;
} else {
...
var _STAR_suppress_read_STAR_24364 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24364;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env24365 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24366 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24366,"(");
...
var G__24367 = (i + (1));
var G__24368 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3920__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3920__auto__)){
return or__3920__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env24365;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24369 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24369);
...
var G__24370 = cljs.core.next.call(null,s__$1);
var G__24371 = ret;
s__$1 = G__24370;
r = G__24371;
continue;
...
var G__24372 = cljs.core.next.call(null,s);
var G__24373 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24372;
key_vals = G__24373;
continue;
} else {
...
var gensym_env24377 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env24377;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24378 = token;
var G__24378__$1 = (((G__24378 == null))?null:cljs.core.subs.call(null,G__24378,(1)));
var G__24378__$2 = (((G__24378__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24378__$1));
var G__24378__$3 = (((G__24378__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24378__$2));
var G__24378__$4 = (((G__24378__$3 == null))?null:cljs.core.symbol.call(null,G__24378__$3));
if((G__24378__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24378__$4);
}
})():(function (){var G__24379 = token;
var G__24379__$1 = (((G__24379 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24379));
if((G__24379__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24379__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
var temp__5718__auto__ = (function (){var or__3920__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__3920__auto__)){
return or__3920__auto__;
} else {
...
}catch (e24386){if((e24386 instanceof Error)){
var e = e24386;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24390,reader){
...
var opts = map__24391__$1;
var eof = cljs.core.get.call(null,map__24391__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4497__auto___24399 = arguments.length;
var i__4498__auto___24400 = (0);
while(true){
if((i__4498__auto___24400 < len__4497__auto___24399)){
args__4500__auto__.push((arguments[i__4498__auto___24400]));

var G__24401 = (i__4498__auto___24400 + (1));
i__4498__auto___24400 = G__24401;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24397){
...
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24398,seq24397__$1);
});


//# sourceMappingURL=reader.js.map?rel=1662169255148
